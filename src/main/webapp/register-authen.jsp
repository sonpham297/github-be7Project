...
<body>
	...
	<!-- Navbar End -->
		...
		<h4 style="display: flex; justify-content: center; align-items: center;">WELCOME TO CHEMIST SALE!</h4>
		<div style="display: flex; justify-content: center; align-items: center;"> ${message} </div>
		<div style="display: flex; justify-content: center; align-items: center;"><a href="home.jsp"><button class="btn btn-primary">Back to HomePage</button></a></div>
