...
<!-- Google Maps API loads asynchronously and runs initAutocomplete() -->
<script async defer src="js/autocomplete.js"></script>
<script async defer
	src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCKvBNnAolx_uhm7YFusjUMt4UutKHrHfs&libraries=places&callback=initAutocomplete"></script>
	...
	<div class="container-fluid  mb-30">
		<div class="row px-xl-5">
			<div class="col-lg-3 d-none d-lg-block">
				<img src="img/guaranteed safe checkout.png"
					alt="safe-secure-checkout-logo" style="width: 750px; height: 80px">
			</div>
		</div>
	</div>
	<!-- Navbar End -->
			...
			<div class="col-lg-8">
				...
				<div class="bg-light p-30 mb-5">
					<div class="row">
						...
						<div class="col-md-6 form-group">
							<label>Confirm E-mail</label> <input class="form-control"
								type="email" name="confirmEmail" id="confirmEmail"
								placeholder="example@email.com"> <small
								class="error-message text-danger"></small>
						</div>
						<div class="col-md-6 form-group">
							<label>Mobile No</label> <input class="form-control" type="text"
								name="phone" id="phone"> <small
								class="error-message text-danger"></small>
						</div>
						<div class="col-md-6 form-group">
						...
						<div class="col-md-6 form-group">
							<label>Postcode</label> <input class="form-control" type="text"
								id="postcode">
						</div>
						<div class="col-md-12 form-group">
							<div class="custom-control custom-checkbox">
								<input type="checkbox" class="custom-control-input" id="manual">
								<label class="custom-control-label" for="manual">Not
									found your address? You can input your address manually.</label>
							</div>
						</div>
						<div class="col-md-12">
							<div class="custom-control custom-checkbox">
								...
								<label class="custom-control-label" for="shipto"
									...
									id="shipTo">Ship to different address</label>
							</div>
						</div>
					</div>
				</div>
				<div class="collapse mb-5" id="shipping-address">
					...
					<div class="bg-light p-30">
						<div class="row">
							...
							<div class="col-md-6 form-group">
								<label>Street Address</label> <input class="form-control"
									type="text" id="difAddress" name="address"
									placeholder="Type your street address">
							</div>
							<div class="col-md-6 form-group">
								<label>City</label> <input class="form-control" type="text"
			...
			<div class="col-lg-4">
				...
				<div class="bg-light p-30 mb-5">
					...
					<div class="border-bottom pt-3 pb-2">
						...
						<div class="justify-content-between" id="appliedVoucher"
							style="display: none;"></div>
						<div class="justify-content-between" id="newSubtotal"
							style="display: none;"></div>
				...
				<div class="mb-5">
					...
					<div class="bg-light p-30">
						...
						<button class="btn btn-block btn-primary font-weight-bold py-3">Place
							Order</button>
					</div>
				</div>
			</div>
	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				<p class="mb-4">We’d love to hear from you! Whether you have
					questions, feedback, or want to learn more about what we do, feel
					free to reach out. Our team is here to help and will respond to
					your inquiry as soon as possible. Contact us via email, phone, or
					by filling out the form—we look forward to connecting with you!</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>557 To Ky
					Street, Trung My Tay Ward, District 12, Ho Chi Minh City, Vietnam
				</p>
				<p class="mb-2">
					...
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-secondary mb-2" href="index.html"><i
								...
								class="text-secondary mb-2" href="shop.html"><i
								class="fa fa-angle-right mr-2"></i>Our Shop</a> <a
								class="text-secondary" href="contact.html"><i
					...
					<div class="col-md-4 mb-5">
						...
						<div class="d-flex flex-column justify-content-start">
							<a class="text-secondary mb-2" href="cart.html"><i
								...
								class="text-secondary mb-2" href="checkout.html"><i
								class="fa fa-angle-right mr-2"></i>Checkout</a>
						</div>
					</div>
					<div class="col-md-4 mb-5">
						<h5 class="text-secondary text-uppercase mb-4">Newsletter</h5>
						<p>Never miss BIG SALES! Subscribe to our newsletter for the
							latest SALES, exclusive offers, and insider tips. Sign up today
							and be part of our growing community—it’s quick, easy, and
							totally free!</p>
						<form action="">
							<div class="input-group">
								<div class="input-group-append">
									<button class="btn btn-primary" type="button"
										onclick="window.location.href='login.jsp'">Sign in</button>
								</div>
							</div>
						</form>
